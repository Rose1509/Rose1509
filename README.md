...
- 💻 I love building and exploring new things in software development.
- 🤖 Interested in Machine Learning & AI, Data Science, and Web Development.
- 🌱 Currently learning FastAPI, ML workflows, and improving my Python & Java skills.
- 🤝 Always open to connecting and collaborating with other developers.
...
- 💨 FastAPI for backend web apps
- 📊 Machine Learning pipelines & workflows
- 🗃️ Database management with MySQL

## 📂 Current Projects

- **Drug Side Effects Analysis** – ML pipeline & data analysis  
...
Thanks for visiting my profile! Feel free to explore my repositories, star projects, or connect with me 🤗
